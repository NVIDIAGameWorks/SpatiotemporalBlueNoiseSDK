...
class SliceCacheController2Dx1Dx1D : public VCController
{
public:
    SliceCacheController2Dx1Dx1D(STBNData& data, SymmetricKernel kernelX, SymmetricKernel kernelY, SymmetricKernel kernelZ, SymmetricKernel kernelW);
